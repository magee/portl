...
//
  ...
  this.route('customers', {
    path: '/customers/',
    onBeforeAction: function() {
      Session.set('pageTitle', 'Shopify Clients');
    },
    waitOn: function () {
  ...
  this.route('orders', {
    ...
    onBeforeAction: function() {
      Session.set('pageTitle', 'Shopify Orders');
    }
  });

  this.route('orderDetails', {
    path: '/orders/:_id',
    waitOn: function() { return [Meteor.subscribe('orders', this.params._id)]; },
    data: function () { return Orders.findOne(this.params._id); },
    onBeforeAction: function() {
      Session.set('pageTitle', 'Shopify Order Details');
    }
  });
